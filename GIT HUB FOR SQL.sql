...
select top 3*from Employee_1Info order by EmpID desc ;
...
--27.Let us jion these two tables using CARTESIAN JOIN as follows.--

SELECT EmpfName,DOB,EmplName FROM Employee_1Info,EmployeePosition;
